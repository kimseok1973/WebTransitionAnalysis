...
# ╔═╡ 3419351c-9d62-11ee-23c1-d9da7de734e1
using Distributions,StatsPlots, Turing

# ╔═╡ 659be5e0-6e12-42c0-9a72-98c2b151ca0b
...
# ╔═╡ 8f8f9b8a-7254-4eb7-8a15-33cc9c5c2ec0
begin
xs = [475_976, 106_555, 30_569, 25_556, 19_453, 7_383]
ys = [39_391, 8_423, 2_429, 941, 764,625,542,342]
end

# ╔═╡ e199c564-5c0b-4802-8d6d-6fc67a423cc2
model=webpanel(xs,ys)

# ╔═╡ aae78c10-2d3e-4656-a8a8-822782b9e639
c=sample(model,NUTS(),4000)

# ╔═╡ 218e5347-c2e9-4c52-a0d0-cd7374e6ef5d
plot(c)
...
julia_version = "1.9.4"
manifest_format = "2.0"
project_hash = "f668eefd82f880e85d46dba1242122cb70ba2500"
